...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Daniel Moura" => "daniel.lucio.moura@gmail.com" }
  # Or just: spec.author    = "Daniel Moura"
  # spec.authors            = { "Daniel Moura" => "daniel.lucio.moura@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Daniel Moura"
